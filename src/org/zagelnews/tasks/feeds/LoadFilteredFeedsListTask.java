...
public class LoadFilteredFeedsListTask extends AsyncTask<String,String,JSONArray>
{

	private FilteredFeedsListActivity activity;
	private Integer feedSeqFrom;

	//for internal use only 
	private LinearLayout linlaFooterProgress = null;

	public LoadFilteredFeedsListTask(FilteredFeedsListActivity activity, Integer feedSeqFrom) {
	...
	protected JSONArray doInBackground(String... args){
		...
		json = feedsFunction.loadFeeds(
				activity.getInterestIds(), 
				feedSeqFrom, 
				activity.getInterestLatitude(), 
				activity.getInterestLongitude(), 
				activity.getInterestRadious(),
				activity.getCurrentLatitude(),
				activity.getCurrentLongitude());
		return json;
	}
